...
## Radial SVM
```{r RSVM}
rsvm.fit <- e1071::svm(SelectedF ~ . - Time - Priority, 
...
## Validation
We're using the second dataset as a validation set. Neither model performs exceptionally well on the validation set. Below is the performance of the Time Difference model on the second dataset.
